...
var file_provider_v1_provider_proto_rawDesc = []byte{
	...
	0x67, 0x65, 0x48, 0x69, 0x6e, 0x74, 0x22, 0x18, 0x0a, 0x16, 0x47, 0x65, 0x74, 0x43, 0x61, 0x70,
	0x61, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x69, 0x65, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x22, 0xdd, 0x03, 0x0a, 0x17, 0x47, 0x65, 0x74, 0x43, 0x61, 0x70, 0x61, 0x62, 0x69, 0x6c, 0x69,
	...
	0x57, 0x4e, 0x5f, 0x47, 0x52, 0x41, 0x43, 0x45, 0x46, 0x55, 0x4c, 0x10, 0x04, 0x32, 0xb4, 0x08,
...
var file_provider_v1_provider_proto_goTypes = []any{
	...
	(*GetCapabilitiesRequest)(nil),  // 23: provider.v1.GetCapabilitiesRequest
	(*GetCapabilitiesResponse)(nil), // 24: provider.v1.GetCapabilitiesResponse
}
var file_provider_v1_provider_proto_depIdxs = []int32{
	...
	10, // 11: provider.v1.Provider.HardwareUpgrade:input_type -> provider.v1.HardwareUpgradeRequest
	12, // 12: provider.v1.Provider.Describe:input_type -> provider.v1.DescribeRequest
	14, // 13: provider.v1.Provider.TaskStatus:input_type -> provider.v1.TaskStatusRequest
	16, // 14: provider.v1.Provider.SnapshotCreate:input_type -> provider.v1.SnapshotCreateRequest
	18, // 15: provider.v1.Provider.SnapshotDelete:input_type -> provider.v1.SnapshotDeleteRequest
	19, // 16: provider.v1.Provider.SnapshotRevert:input_type -> provider.v1.SnapshotRevertRequest
	20, // 17: provider.v1.Provider.Clone:input_type -> provider.v1.CloneRequest
	22, // 18: provider.v1.Provider.ImagePrepare:input_type -> provider.v1.ImagePrepareRequest
	23, // 19: provider.v1.Provider.GetCapabilities:input_type -> provider.v1.GetCapabilitiesRequest
	4,  // 20: provider.v1.Provider.Validate:output_type -> provider.v1.ValidateResponse
	6,  // 21: provider.v1.Provider.Create:output_type -> provider.v1.CreateResponse
	11, // 22: provider.v1.Provider.Delete:output_type -> provider.v1.TaskResponse
	11, // 23: provider.v1.Provider.Power:output_type -> provider.v1.TaskResponse
	11, // 24: provider.v1.Provider.Reconfigure:output_type -> provider.v1.TaskResponse
	11, // 25: provider.v1.Provider.HardwareUpgrade:output_type -> provider.v1.TaskResponse
	13, // 26: provider.v1.Provider.Describe:output_type -> provider.v1.DescribeResponse
	15, // 27: provider.v1.Provider.TaskStatus:output_type -> provider.v1.TaskStatusResponse
	17, // 28: provider.v1.Provider.SnapshotCreate:output_type -> provider.v1.SnapshotCreateResponse
	11, // 29: provider.v1.Provider.SnapshotDelete:output_type -> provider.v1.TaskResponse
	11, // 30: provider.v1.Provider.SnapshotRevert:output_type -> provider.v1.TaskResponse
	21, // 31: provider.v1.Provider.Clone:output_type -> provider.v1.CloneResponse
	11, // 32: provider.v1.Provider.ImagePrepare:output_type -> provider.v1.TaskResponse
	24, // 33: provider.v1.Provider.GetCapabilities:output_type -> provider.v1.GetCapabilitiesResponse
