...
- Docs: `docs/image-preparation.md` (the new contract and status field; what the source digest covers and excludes, including the Q7 refinement; the limitation stands until the later slices), `docs/upgrading.md` (readiness fields).
