...
// ListHosts is the gRPC host-inventory RPC (ADR-0007 P1). The vSphere provider
// is a single-endpoint (thin-client) provider — vCenter owns host placement and
// clustering (DRS) itself — so it does not participate in the operator-driven
// clustering model. It reports Unimplemented and advertises
...
// on vSphere for the same reason as ListHosts.
