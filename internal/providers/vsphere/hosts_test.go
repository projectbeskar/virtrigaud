...
// TestListHosts_Unimplemented pins that vSphere — a thin-client provider that
// does not participate in operator-driven clustering — reports the ADR-0007 P1
...
// TestGetCapabilities_SupportsClusteringFalse pins honesty-first (D7): vSphere
// advertises supports_clustering = false.
