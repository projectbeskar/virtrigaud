...
# BUILDER_IMAGE must satisfy the Go version in go.mod (currently 1.26.5); the
...
# "go.mod requires go >= 1.26.5". Keep this in lockstep with go.mod.
BUILDER_IMAGE ?= golang:1.26.5
