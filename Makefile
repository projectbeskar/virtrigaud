...
# BUILDER_IMAGE must satisfy the Go version in go.mod (currently 1.26.6); the
...
# "go.mod requires go >= 1.26.6". Keep this in lockstep with go.mod.
BUILDER_IMAGE ?= golang:1.26.6
