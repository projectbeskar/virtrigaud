...
- **Rolling a provider back holds image prepares.** A provider image older than
  ...
  and nothing is recorded. Either way it fails closed. Images already prepared under
  the new scheme stay usable.
